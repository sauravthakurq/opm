...
import iad1tya.echo.kotlinytmusicscraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import iad1tya.echo.kotlinytmusicscraper.extension.toListFormat
...
import iad1tya.echo.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
...
import iad1tya.echo.kotlinytmusicscraper.models.PoToken
import iad1tya.echo.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import iad1tya.echo.kotlinytmusicscraper.models.Run
import iad1tya.echo.kotlinytmusicscraper.models.SearchSuggestions
import iad1tya.echo.kotlinytmusicscraper.models.SongInfo
...
import iad1tya.echo.kotlinytmusicscraper.models.YTItemType
...
import iad1tya.echo.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
...
import iad1tya.echo.kotlinytmusicscraper.models.getContinuation
import iad1tya.echo.kotlinytmusicscraper.models.oddElements
import iad1tya.echo.kotlinytmusicscraper.models.response.AccountMenuResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.BrowseResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.DownloadProgress
import iad1tya.echo.kotlinytmusicscraper.models.response.GetQueueResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.LikeStatus
import iad1tya.echo.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import iad1tya.echo.kotlinytmusicscraper.models.response.NextResponse
...
import iad1tya.echo.kotlinytmusicscraper.models.response.toLikeStatus
...
import iad1tya.echo.kotlinytmusicscraper.models.youtube.GhostResponse
import iad1tya.echo.kotlinytmusicscraper.models.youtube.Transcript
import iad1tya.echo.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import iad1tya.echo.kotlinytmusicscraper.pages.AlbumPage
import iad1tya.echo.kotlinytmusicscraper.pages.ArtistPage
import iad1tya.echo.kotlinytmusicscraper.pages.ArtistSection
import iad1tya.echo.kotlinytmusicscraper.pages.BrowseResult
import iad1tya.echo.kotlinytmusicscraper.pages.ExplorePage
import iad1tya.echo.kotlinytmusicscraper.pages.MoodAndGenres
import iad1tya.echo.kotlinytmusicscraper.pages.NextPage
import iad1tya.echo.kotlinytmusicscraper.pages.NextResult
import iad1tya.echo.kotlinytmusicscraper.pages.PlaylistContinuationPage
import iad1tya.echo.kotlinytmusicscraper.pages.PlaylistPage
import iad1tya.echo.kotlinytmusicscraper.pages.RelatedPage
import iad1tya.echo.kotlinytmusicscraper.pages.SearchPage
import iad1tya.echo.kotlinytmusicscraper.pages.SearchResult
import iad1tya.echo.kotlinytmusicscraper.pages.SearchSuggestionPage
import iad1tya.echo.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import iad1tya.echo.kotlinytmusicscraper.parser.fromPlaylistToTrack
import iad1tya.echo.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import iad1tya.echo.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import iad1tya.echo.kotlinytmusicscraper.parser.getPlaylistContinuation
import iad1tya.echo.kotlinytmusicscraper.parser.getReloadParams
import iad1tya.echo.kotlinytmusicscraper.parser.getSuggestionSongItems
import iad1tya.echo.kotlinytmusicscraper.parser.hasReloadParams
import iad1tya.echo.kotlinytmusicscraper.utils.NewPipeDownloaderImpl
import iad1tya.echo.kotlinytmusicscraper.utils.NewPipeUtils
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.NewPipePoTokenProviderImpl
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.PoTokenGenerator
...
//            YoutubeJavaScriptPlayerManager.getUrlWithThrottlingParameterDeobfuscated(videoId, url.toString())
            ...
            val decodedCipher = cipher // Fallback to original cipher
            val fixedThrottling = nSigParam // Fallback to original nSigParam
                    ...
                    if (isVideo) {
                        ...
                        runCatching {
                            ...
                            try {
                                ...
                                if (FileSystem.SYSTEM.exists("$filePath-echo.mp3".toPath())) {
                                    FileSystem.SYSTEM.delete("$filePath-echo.mp3".toPath())
                                }
                            } catch (e: IOException) {
                                e.printStackTrace()
                            }
