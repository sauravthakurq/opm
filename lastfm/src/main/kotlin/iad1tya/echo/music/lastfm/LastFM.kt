...
package iad1tya.echo.music.lastfm

import iad1tya.echo.music.lastfm.models.Authentication
import iad1tya.echo.music.lastfm.models.LastFmError
import iad1tya.echo.music.lastfm.models.TokenResponse
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        userAgent("Echo Music (https://echomusic.fun)")
