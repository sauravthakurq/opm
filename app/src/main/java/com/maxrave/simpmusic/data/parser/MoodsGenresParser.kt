...
import iad1tya.echo.music.data.model.explore.mood.genre.ItemsSong
import iad1tya.echo.music.data.model.explore.mood.genre.Title
import iad1tya.echo.music.data.model.explore.mood.moodmoments.Content
        ...
        if (items != null) {
            for (item in items) {
                if (item.musicCarouselShelfRenderer != null) {
                    ...
                    val listContent: MutableList<iad1tya.echo.music.data.model.explore.mood.genre.Content> = mutableListOf()
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                // Song
                                ...
                                val playlistBrowseId =
                                    content.musicTwoRowItemRenderer
                                        ...
                                        ?.browseId
                                listContent.add(
                                    iad1tya.echo.music.data.model.explore.mood.genre.Content(
                                        playlistBrowseId = playlistBrowseId ?: "",
