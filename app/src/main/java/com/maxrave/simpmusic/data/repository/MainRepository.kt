...
import iad1tya.echo.music.extension.toLibraryLyrics
...
import aditya.echo.lyrics.EchoLyricsClient
...
class MainRepository(
    ...
    private val simpMusicLyrics: EchoLyricsClient,
...
//                )
    ...
    // SimpMusic Lyrics
    private val simpMusicLyricsTag = "EchoLyricsRepository"

    fun getEchoLyrics(videoId: String): Flow<Resource<Lyrics>> =
        flow {
            simpMusicLyrics
                .getLyrics(videoId)
                .onSuccess { lyrics ->
