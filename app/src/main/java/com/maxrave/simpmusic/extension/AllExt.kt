...
import iad1tya.echo.music.data.model.browse.artist.ResultSong
import iad1tya.echo.music.data.model.browse.artist.ResultVideo
...
import iad1tya.echo.music.viewModel.ArtistScreenData
...
fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                iad1tya.echo.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            iad1tya.echo.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
fun aditya.echo.lyrics.domain.Lyrics.toLyrics(): Lyrics {
...
fun Lyrics.toLibraryLyrics(): aditya.echo.lyrics.domain.Lyrics =
    aditya.echo.lyrics.domain.Lyrics(
        lyrics =
            aditya.echo.lyrics.domain.Lyrics.LyricsX(
                lines =
                    this.lines?.map {
                        aditya.echo.lyrics.domain.Lyrics.LyricsX.Line(
                            endTimeMs = it.endTimeMs,
                            startTimeMs = it.startTimeMs,
                            syllables = listOf(),
                            words = it.words,
