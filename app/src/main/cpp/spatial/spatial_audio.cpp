...
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nApplyAIState(JNIEnv *env, jobject thiz, 
...
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nGetPeakLevel(JNIEnv *env, jobject thiz) {
    return AIAudioProcessor::getLatestStats().peakLevel;
}

extern "C"
JNIEXPORT jfloat JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nGetRmsLevel(JNIEnv *env, jobject thiz) {
    return AIAudioProcessor::getLatestStats().rmsLevel;
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nProcessPcm16(JNIEnv *env, jobject thiz,
                                                                   jobject buffer,
                                                                   jint frameCount,
                                                                   jint channelCount,
                                                                   jint sampleRate,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetEqEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    equalizer.setEnabled(enabled);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetEqBand(JNIEnv *env, jobject thiz, jint bandIndex, jfloat gainDb) {
    equalizer.setBandGain(bandIndex, gainDb);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetEqPreamp(JNIEnv *env, jobject thiz, jfloat gainDb) {
    equalizer.setPreamp(gainDb);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetBassBoost(JNIEnv *env, jobject thiz, jfloat strength) {
    bassBoost.setStrength(strength);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetVirtualizer(JNIEnv *env, jobject thiz, jfloat strength) {
    virtualizer.setStrength(strength);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetCrossfeedParams(JNIEnv *env, jobject thiz, jboolean enabled, jfloat strength) {
    crossfeed.setParams(enabled, strength);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetPlaybackParams(JNIEnv *env, jobject thiz, jfloat pitch) {
    pitchShifter.setParams(pitch, 44100);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nReset(JNIEnv *env, jobject thiz) {
    spatializer.reset();
    limiter.reset();
    crossfeed.reset();
    equalizer.reset();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetSpatializerEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    spatializer.setEnabled(enabled);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetLimiterEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    limiter.setEnabled(enabled);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetLimiterParams(JNIEnv *env, jobject thiz, 
...
extern "C"
JNIEXPORT void JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nSetLimiterBalance(JNIEnv *env, jobject thiz, jfloat balance) {
    limiter.setBalance(balance);
}

extern "C"
JNIEXPORT jfloat JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nGetEqBand(JNIEnv *env, jobject thiz, jint index) {
    return equalizer.getBandGain(index);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nIsEqEnabled(JNIEnv *env, jobject thiz) {
    return equalizer.isEnabled();
}

extern "C"
JNIEXPORT jfloat JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nGetBassBoost(JNIEnv *env, jobject thiz) {
    return bassBoost.getStrength();
}

extern "C"
JNIEXPORT jfloat JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nGetVirtualizer(JNIEnv *env, jobject thiz) {
    return virtualizer.getStrength();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_music_vivi_playback_audio_spatial_NativeSpatialAudio_nIsSpatializerEnabled(JNIEnv *env, jobject thiz) {
