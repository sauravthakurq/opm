...
import iad1tya.echo.music.ui.component.LyricsShareImageOptions
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: iad1tya.echo.music.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap = withContext(Dispatchers.Default) {
        val style = glassStyle ?: iad1tya.echo.music.ui.component.LyricsGlassStyle.FrostedDark
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Echo Music")
            }
