...
class DiscordRPC(
    ...
    suspend fun updateSong(
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://echomusic.fun"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            iad1tya.echo.music.utils.GlobalLog.append(
