...
class EchoLyrics(
    ...
    private val baseUrl = "https://api-lyrics.echo.org/v1/"
    ...
    private fun createClient() =
        HttpClient(OkHttp) {
            ...
            defaultRequest {
                url("https://api-lyrics.echo.org/v1")
            }
            if (proxy != null) {
                engine {
                    proxy = this@EchoLyrics.proxy
                }
            }
        }
    ...
    private fun HttpRequestBuilder.buildDefaultHeaders(
        ...
        headers {
            ...
            header(HttpHeaders.UserAgent, "EchoLyrics/1.0")
